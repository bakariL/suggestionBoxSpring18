...
namespace SuggestionBox.Controllers
{
    public class SuggestionModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SugesstionID,Topic,Suggestion")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SugesstionID,Topic,Suggestion")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
